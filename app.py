...
app.config["SECRET_KEY"] = "b46bbed6ebdd32ec19353f97ad15e15d1872070f"
app.config["MONGO_URI"] = 'mongodb+srv://mongodb:LfuEXm0UVeopJoUi@cluster0.1enkv.mongodb.net/?retryWrites=true&w=majority'
...
def by_id(item_id):
    ...
    try:
        if (request.method == 'POST'):
            res = db['template'].update_one({"_id": ObjectId(item_id)}, {
